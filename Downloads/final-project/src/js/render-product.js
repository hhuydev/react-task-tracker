$(function () {
  $(
    ".section-grid-product .container .row .col-md-10 .section-right .products-owl #render-area"
  ).owlCarousel();
  const products = [
    {
      id: 1,
  ...
  const allCategory = $(
    ".section-grid-product .container .row .col-md-10 .section-right .products-area .row .col-sm-8 .categories a"
  );
  ...
  list.reverse().map((val, index) => {
    ...
    $(selector)
      .trigger("add.owl.carousel", [
        //   `<div class='item-img'><img src=${val.image}></div>`,
